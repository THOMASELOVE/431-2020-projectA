...
4. The `Hmisc::describe` result for your `chr_2020` tibble. As in element 3, code alone is fine for this element.
...
1. Dr. Love will provide a sample project "proposal" document to you as part of his [Examples](examples.html).
...
- **Please** meet the deadline, and don't wait until the last minute to do the work.
    - Late work on the projects (proposal or final submission) will be **severely** penalized, much more so than late work on labs. A late proposal will not score more than 20 points out of 25 and may score appreciably lower depending on the situation.
