...
**NEW** Dr. Love has provided a detailed outline for each of these Analyses as part of the [Examples](examples.html) page. You'll find that outline incorporated into the descriptions below, too.
...
The [outline Dr. Love has prepared for Analysis 1](https://thomaselove.github.io/431-2020-projectA/examples.html) includes the following subsections. See that outline for more details in terms of what needs to go where, and additional guidance to help you complete the project effectively.
...
The [outline Dr. Love has prepared for Analysis 2](https://thomaselove.github.io/431-2020-projectA/examples.html) includes the following subsections. See that outline for more details in terms of what needs to go where, and additional guidance to help you complete the project effectively.
...
The [outline Dr. Love has prepared for Analysis 3](https://thomaselove.github.io/431-2020-projectA/examples.html) includes the following subsections. See that outline for more details in terms of what needs to go where, and additional guidance to help you complete the project effectively.
