...
- **Cleaning the Data**: To build your data set, which we'll be a sample of the full data, you will do a series of things in R.
        ...
        - Some of those variables will be included as quantitative, and others will require you to use R to create categories.
        - Creating a tibble of your selected counties, and your set of 8 variables will be necessary to complete the proposal.
...
- **Examples from Dr. Love**: We will provide a sample analysis using R Markdown to study data from a previous year's data from County Health Rankings, so that you'll have an example to use in preparing your project proposal, and your final project report. Examples will be available by 2020-10-22.
